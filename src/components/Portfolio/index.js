            ...
            <Card.Img style={{ width: '18rem', margin:'auto' }} variant="top" src={require(`../../assets/projects/devtrax.png`).default} />
                <Card.Body>
                    <Card.Title>DevTrax</Card.Title>
                        ...
                        <a href="https://infinite-shore-33875.herokuapp.com/" target="_blank" rel="noreferrer">
                        <Button  variant="dark" className='justify-center'>W E B S I T E</Button>
                        </a>
                    <br></br>
                    <br></br>
                    <a href="https://github.com/joshacross/devtrax" target="_blank" rel="noreferrer">
            ...
            <Card.Img style={{ width: '18rem', margin:'auto' }} variant="top" src={require(`../../assets/projects/taskmaster-iphone.png`).default} />
                <Card.Body>
                    <Card.Title>Taskmaster Pro V2</Card.Title>
                        ...
                        <a  href="https://joshacross.github.io/taskmaster-pro/" target="_blank" rel="noreferrer">
                            <Button variant="dark">W E B S I T E</Button>
                        </a>
                        <br></br>
                        <br></br>
                        <a  href="https://github.com/joshacross/taskmaster-pro" target="_blank" rel="noreferrer">
                        <Button variant="dark">G I T H U B</Button>
                        </a>
                </Card.Body>
            </Card>
            ...
            <Card.Img style={{ width: '18rem', margin:'auto' }} variant="top" src={require(`../../assets/projects/motivation-manager.png`).default} />
                <Card.Body>
                    <Card.Title>Motivation Manager</Card.Title>
                        ...
                        <a  href="https://github.com/JohnBanas/motivation-manager" target="_blank" rel="noreferrer">
                        <Button variant="dark">W E B S I T E</Button>
                        </a>
                        <br></br>
                        <br></br>
                        <a  href="https://johnbanas.github.io/motivation-manager/" target="_blank" rel="noreferrer">
                            <Button variant="dark">G I T H U B</Button>
                        </a>
                </Card.Body>
            </Card>
            ...
            <Card.Img variant="top" src={require(`../../assets/projects/ohsnap.png`).default} />
                <Card.Body>
                    <Card.Title>Oh Snap!</Card.Title>
                        ...
                        <a href="https://joshacross.github.io/photo-port/" target="_blank" rel="noreferrer">
                        <Button variant="dark">W E B S I T E</Button>
                        </a>
                        <br></br>
                        <br></br>
                        <a  href='https://github.com/joshacross/photo-port' target="_blank" rel="noreferrer">
                            <Button variant="dark">G I T H U B</Button>
                        </a>
                </Card.Body>
            </Card>
