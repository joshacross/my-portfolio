        ...
        <Card style={{ width: '32rem' }}>
            <Card.Img style={{ width: '18rem', margin:'auto' }} variant="top" src={require(`../../assets/projects/devtrax.png`).default} />
                <Card.Body>
                    ...
                    <Button href="https://infinite-shore-33875.herokuapp.com/" variant="dark" className='justify-center'>W E B S I T E</Button>
                    <br></br>
                    <br></br>
                    <Button href="https://github.com/joshacross/devtrax" variant="dark">G I T H U B</Button>
                </Card.Body>
            </Card>
            </Col>
            ...
            <Card.Img style={{ width: '18rem', margin:'auto' }} variant="top" src={require(`../../assets/projects/taskmaster-iphone.png`).default} />
                <Card.Body>
                    <Card.Title>Taskmaster Pro V2</Card.Title>
                        ...
                        <Button href="https://joshacross.github.io/taskmaster-pro/" variant="dark">W E B S I T E</Button>
                        <br></br>
                        <br></br>
                        <Button href="https://github.com/joshacross/taskmaster-pro" variant="dark">G I T H U B</Button>
                </Card.Body>
            </Card>
            </Col>
            </Row>
            ...
            <Card.Img style={{ width: '18rem', margin:'auto' }} variant="top" src={require(`../../assets/projects/motivation-manager.png`).default} />
                <Card.Body>
                    <Card.Title>Motivation Manager</Card.Title>
                        ...
                        <Button href="https://github.com/JohnBanas/motivation-manager" variant="dark">W E B S I T E</Button>
                        <br></br>
                        <br></br>
                        <Button href="https://johnbanas.github.io/motivation-manager/" variant="dark">G I T H U B</Button>
                </Card.Body>
            </Card>
            </Col>
            ...
            <Card.Img variant="top" src={require(`../../assets/projects/ohsnap.png`).default} />
                <Card.Body>
                    <Card.Title>Oh Snap!</Card.Title>
                        ...
                        <Button href="https://joshacross.github.io/photo-port/" variant="dark">W E B S I T E</Button>
                        <br></br>
                        <br></br>
                        <Button href='https://github.com/joshacross/photo-port' variant="dark">G I T H U B</Button>
                </Card.Body>
            </Card>
            </Col>
            </Row>
